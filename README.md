...
R package **piamInterfaces**, version **0.49.1**
...
Benke F, Richters O (2025). "piamInterfaces: Project specific interfaces to REMIND / MAgPIE." Version: 0.49.1, <https://github.com/pik-piam/piamInterfaces>.
