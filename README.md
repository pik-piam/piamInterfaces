...
R package **piamInterfaces**, version **0.64.2**
...
Benke F, Richters O (2026). "piamInterfaces: Project specific interfaces to REMIND / MAgPIE." Version: 0.64.2, <https://github.com/pik-piam/piamInterfaces>.
