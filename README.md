...
R package **piamInterfaces**, version **0.48.11**
...
Benke F, Richters O (2025). "piamInterfaces: Project specific interfaces to REMIND / MAgPIE." Version: 0.48.11, <https://github.com/pik-piam/piamInterfaces>.
