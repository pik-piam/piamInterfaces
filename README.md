...
R package **piamInterfaces**, version **0.55.0**
...
Benke F, Richters O (2025). "piamInterfaces: Project specific interfaces to REMIND / MAgPIE." Version: 0.55.0, <https://github.com/pik-piam/piamInterfaces>.
