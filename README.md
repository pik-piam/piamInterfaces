...
R package **piamInterfaces**, version **0.65.2**
...
Benke F, Richters O (2026). "piamInterfaces: Project specific interfaces to REMIND / MAgPIE." Version: 0.65.2, <https://github.com/pik-piam/piamInterfaces>.
