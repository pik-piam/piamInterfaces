...
R package **piamInterfaces**, version **0.51.2**
...
Benke F, Richters O (2025). "piamInterfaces: Project specific interfaces to REMIND / MAgPIE." Version: 0.51.2, <https://github.com/pik-piam/piamInterfaces>.
