...
R package **piamInterfaces**, version **0.53.12**
...
Benke F, Richters O (2025). "piamInterfaces: Project specific interfaces to REMIND / MAgPIE." Version: 0.53.12, <https://github.com/pik-piam/piamInterfaces>.
